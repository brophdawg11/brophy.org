  ...
  jobs: [
    {
      ...
      details: [
        ...
        [
          ...
          '[Lazy Route Discovery](https://remix.run/docs/en/main/guides/lazy-route-discovery)',
        ],
        'Implemented new React Router v6 features including:',
        [
          '[dataStrategy](https://reactrouter.com/v6/routers/create-browser-router#optsdatastrategy)',
